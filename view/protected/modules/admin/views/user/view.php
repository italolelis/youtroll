...
<div class="form-edit-user">
    ...
    <?php echo $formEditUser->dropDownListRow($userEditForm, 'status', $status, array('name' => 'UserEditForm[usr_status]'));
    ?>       
    ...
    <?php echo $formEditUser->dropDownListRow($userEditForm, 'gender', $genders, array('name' => 'UserEditForm[usr_gender]'));
    ?>       
