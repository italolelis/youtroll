            ...
            array(
                ...
                'items' => array(
                    ...
                    array(
                        ...
                        'url' => array('user/createPublication'),
                        'itemOptions' => array('id' => 'createPublicationNav'),
                        'linkOptions' => array('ajax' => HView::getAjaxMenuArrayConfig('createPublication', 'user')),
                    ),
                    array(
                        'label' => HApp::t('sendPublication'),
                        'url' => array('user/sendPublication'),
                        'itemOptions' => array('id' => 'sendPublicationNav'),
                        'linkOptions' => array('ajax' => HView::getAjaxMenuArrayConfig('sendPublication', 'user')),
                    ),
                ),
