 ...
 * @property Publications $pbctTagFkImage
 * @property Publications $pbctTagFkChannelSection
 * @property Tags $pbctTagFkTag
 */
class PublicationsTag extends CActiveRecord
{
     ...
     * @return PublicationsTag the static model class
     */
    ...
    public function relations()
    {
        ...
        return array(
            'pbctTagFkImage' => array(self::BELONGS_TO, 'Publications', 'pbct_tag_fk_image'),
            'pbctTagFkChannelSection' => array(self::BELONGS_TO, 'Publications', 'pbct_tag_fk_channel_section'),
            'pbctTagFkTag' => array(self::BELONGS_TO, 'Tags', 'pbct_tag_fk_tag'),
        );
    }
