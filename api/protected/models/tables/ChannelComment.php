 ...
 * @property Users $chnlCmntFkSender
 * @property Channels $chnlCmntFkChannel
 */
class ChannelComment extends CActiveRecord
{
	 ...
	 * @return ChannelComment the static model class
	 */
	...
	public function relations()
	{
		...
		return array(
			'chnlCmntFkSender' => array(self::BELONGS_TO, 'Users', 'chnl_cmnt_fk_sender'),
			'chnlCmntFkChannel' => array(self::BELONGS_TO, 'Channels', 'chnl_cmnt_fk_channel'),
		);
	}
