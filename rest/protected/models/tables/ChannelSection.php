...
class ChannelSection extends CActiveRecord
{
     ...
     * @return ChannelSections the static model class
     */
    ...
    public function relations()
    {
        ...
        return array(
            'channel' => array(self::BELONGS_TO, 'Channel', 'chnl_sct_fk_channel'),
            'publications' => array(self::HAS_MANY, 'Publication', 'pbct_channel_section_id'),
        );
    }
